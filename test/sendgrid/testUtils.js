// Utility functions for SendGrid tests
const RATE_LIMIT_DELAY = 600; // 600ms delay between requests (2 requests per second limit)

/**
 * Add a delay to respect SendGrid's rate limiting (2 requests per second)
 */
...
/**
 * Create a standard test context for SendGrid components
 */
